...
export const BookPage = (props) => {
    return <Layout>
        <div className={ styles.row }>
            <BookCard BookName={ props.book.name } BookAuthor={ props.book.author } BookGenre={ props.book.genre } Price={ props.book.price +'₽'} key={ props.book.id }></BookCard>
        ...
        <div className={ styles.reviews }>
            { props.book.reviews.map((review) => <ReviewCard author={ review.user.name }>{ review.text }</ReviewCard>) }
